...
#Start by investigating the difference in means
...
#Two sample t-test to compare which species had a greater of lower petal length
t.test(iris$Species[iris$Petal.Length.Class=="Low"], iris$Species[iris$Petal.Length.Class=="High"], na.rm = TRUE)

#Linear regression of Species and Petal Length
